...
func init() {
	parse.Register("bodyepapprove.Modifier", modifierFromJSON)
}
...
type Request struct {
	...
	ExpressPayout   *ExpressPayout `xml:"expressPayout" json:"expressPayout"`
}

type ExpressPayout struct {
    DailyLimit float32 `xml:"dailyLimit" json:"dailyLimit"`
}
